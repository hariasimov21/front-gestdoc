  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Gestión de Usuario/Sociedad</h1>
          <p className="text-muted-foreground mt-2">
            Asocia usuarios a sociedades y visualiza las relaciones existentes.
          </p>
        </div>
        <Button onClick={() => setIsModalOpen(true)}>
          <PlusCircle className="mr-2 h-4 w-4" />
          Asociar Usuario a Sociedad
        </Button>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-8 items-start">
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><Users className="h-5 w-5" /> Ver por Usuario</CardTitle>
          </CardHeader>
            ...
            />
             ...
             {userSocieties.length > 0 && (
                <div className="space-y-2">
                    ...
                    <ul className="list-disc list-inside bg-secondary p-3 rounded-md">
                                 ...
                                 <AlertDialog>
                                    ...
                                    <AlertDialogContent>
                                        ...
                                        <AlertDialogFooter>
                                            ...
                                            <AlertDialogAction onClick={() => handleDelete(Number(selectedUserId), society.id_sociedad)} className="bg-destructive hover:bg-destructive/90">
                                                Desasociar
                                            </AlertDialogAction>
                                        </AlertDialogFooter>
                                    </AlertDialogContent>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2"><Briefcase className="h-5 w-5" /> Ver por Sociedad</CardTitle>
          </CardHeader>
          <CardContent className="space-y-4">
             <Combobox
                            ...
                            <li key={user.id_usuario} className="flex items-center justify-between">
                               ...
                               <AlertDialog>
                                    ...
                                    <AlertDialogContent>
                                        ...
                                        <AlertDialogFooter>
                                            <AlertDialogCancel>Cancelar</AlertDialogCancel>
                                            <AlertDialogAction onClick={() => handleDelete(user.id_usuario, Number(selectedSocietyId))} className="bg-destructive hover:bg-destructive/90">
                                                Desasociar
                                            </AlertDialogAction>
                                        </AlertDialogFooter>
                                    </AlertDialogContent>
